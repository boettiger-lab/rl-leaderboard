...
Welcome to the Conservation Agents Leaderboard.<br /><br />On this left side-panel, context is provided for the environments from the [Wildfire Gym](https://github.com/boettiger-lab/gym_wildfire). The right side-panel hosts the leaderboard where submitted agents are evaluated.


### wildfireCA-v0

This environment is based on a wildfire cellular automata model from [Alexandridis et al.](https://www.sciencedirect.com/science/article/abs/pii/S0096300308004943) 
